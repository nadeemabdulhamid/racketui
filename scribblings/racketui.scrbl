...
@(define-runtime-path screenshots "./screenshots/")
...
@image[#:scale .5 (build-path screenshots "acronym-input.png")]
...
@image[#:scale .5 (build-path screenshots "acronym-result.png")]
...
@image[#:scale .5 (build-path screenshots "clock-input.png")]

and the result after applying the function:

@image[#:scale .5 (build-path screenshots "clock-result.png")]
...
@image[#:scale .5 (build-path screenshots "encryptor-saved.png")]
